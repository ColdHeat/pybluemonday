...
/* 21 */ _CFFI_OP(_CFFI_OP_FUNCTION, 36), // void()(unsigned long, char *, char *, char *, char *, char *, char *)
/* 22 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 10),
...
/* 30 */ _CFFI_OP(_CFFI_OP_FUNCTION, 36), // void()(unsigned long, char *, unsigned int)
/* 31 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 10),
/* 32 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/* 33 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 8), // unsigned int
/* 34 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 35 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 2), // char
/* 36 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};

static void _cffi_d_CallAttrBuilderPolicyFunction(unsigned long x0, char * x1, char * x2, char * x3, char * x4, char * x5, char * x6)
{
  CallAttrBuilderPolicyFunction(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_CallAttrBuilderPolicyFunction(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "CallAttrBuilderPolicyFunction", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
...
{
  CallPolicyFunction(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_CallPolicyFunction(PyObject *self, PyObject *args)
{
  unsigned long x0;
  char * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "CallPolicyFunction", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_CallPolicyFunction _cffi_d_CallPolicyFunction
#endif

static void _cffi_d_CallPolicyFunctionWithBool(unsigned long x0, char * x1, unsigned int x2)
{
  CallPolicyFunctionWithBool(x0, x1, x2);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_CallPolicyFunctionWithBool(PyObject *self, PyObject *args)
{
  unsigned long x0;
  char * x1;
  unsigned int x2;
  ...
  if (!PyArg_UnpackTuple(args, "CallPolicyFunctionWithBool", 3, 3, &arg0, &arg1, &arg2))
    return NULL;
...
#else
#  define _cffi_f_CallPolicyFunctionWithBool _cffi_d_CallPolicyFunctionWithBool
#endif

static void _cffi_d_CallPolicyFunctionWithString(unsigned long x0, char * x1, char * x2)
{
  CallPolicyFunctionWithString(x0, x1, x2);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_CallPolicyFunctionWithString(PyObject *self, PyObject *args)
{
  unsigned long x0;
  char * x1;
  char * x2;
  ...
  if (!PyArg_UnpackTuple(args, "CallPolicyFunctionWithString", 3, 3, &arg0, &arg1, &arg2))
    return NULL;
...
#else
#  define _cffi_f_CallPolicyFunctionWithString _cffi_d_CallPolicyFunctionWithString
#endif

static void _cffi_d_DestroyPolicy(unsigned long x0)
{
  DestroyPolicy(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_DestroyPolicy(PyObject *self, PyObject *arg0)
{
  unsigned long x0;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_SanitizeWithPolicy(PyObject *self, PyObject *args)
{
  unsigned long x0;
  char * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "SanitizeWithPolicy", 2, 2, &arg0, &arg1))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = SanitizeWithPolicy(x0, x1); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "CallAttrBuilderPolicyFunction", (void *)_cffi_f_CallAttrBuilderPolicyFunction, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 21), (void *)_cffi_d_CallAttrBuilderPolicyFunction },
  { "CallPolicyFunction", (void *)_cffi_f_CallPolicyFunction, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 12), (void *)_cffi_d_CallPolicyFunction },
  { "CallPolicyFunctionWithBool", (void *)_cffi_f_CallPolicyFunctionWithBool, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 30), (void *)_cffi_d_CallPolicyFunctionWithBool },
  { "CallPolicyFunctionWithString", (void *)_cffi_f_CallPolicyFunctionWithString, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 16), (void *)_cffi_d_CallPolicyFunctionWithString },
  { "DestroyPolicy", (void *)_cffi_f_DestroyPolicy, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 9), (void *)_cffi_d_DestroyPolicy },
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_bluemonday(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_bluemonday(void) { return NULL; }
#  else
     initbluemonday(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_bluemonday(void)
{
  return _cffi_init("bluemonday", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initbluemonday(void)
{
  _cffi_init("bluemonday", 0x2601, &_cffi_type_context);
}
#endif
